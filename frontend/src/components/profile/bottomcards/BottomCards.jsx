...
export default function BottomCards({ onLogout, onChangePassword, education, dateOfBirth }) {
        ...
        <div className="bottomcards">
            ...
            <div className="bottom-card mgmt-card">
                ...
                <div className="mgmt-actions">
                    ...
                    <button className="mgmt-btn change-password-btn" onClick={onChangePassword}>
