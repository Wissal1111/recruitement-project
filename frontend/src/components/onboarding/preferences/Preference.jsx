...
export default function Preference({ setStep, handleSubmitProfile }) {
    ...
    const handleComplete = async () => {
        ...
        try {
            ...
            // let the parent handle errors; just stop loading
            setLoading(false);
        }
        // If navigation happens in the parent, this won't run — that's fine.
        // If not, stop the spinner so the user isn't stuck.
        setLoading(false);
    };
                ...
                <div className="preference">
                    ...
                    <div className="preference-container">
                        <div className="preference-form">
                            ...
                            <div className="input">
                                <label htmlFor="frequency" className='lbl'>USAGE FREQUENCY</label>
                            ...
                            <div className="input">
                                <label htmlFor="referral" className='lbl'>HOW DID YOU HEAR ABOUT US?</label>
                                <input type="text" id="referral" name="referral" placeholder="e.g. Professional network, Newsletter, Podcast..." />
                            </div>
